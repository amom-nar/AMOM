...
XSUM_KWARGS = dict(beam=1, lenpen=1.0, max_len_b=60, min_len=10, no_repeat_ngram_size=3, iter_decode_max_iter=3, iter_decode_force_max_iter=True)
CNN_KWARGS = dict(beam=4, lenpen=2.0, max_len_b=140, min_len=55, no_repeat_ngram_size=3, iter_decode_max_iter=3, iter_decode_force_max_iter=True)
